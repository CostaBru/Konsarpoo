...
namespace Konsarpoo.Collections
{
    ...
    internal class MMapListBase<T> : IEnumerable, IEnumerable<T>
    {
        ...
        private readonly int m_arrayId;
        ...
        public void LoadStorage(MemoryMappedDataSerializationInfo info)
        {
            m_items = info.ReadArray<T>(m_arrayId);
        }

        public void SaveStorage(MemoryMappedDataSerializationInfo info)
        {
            info.WriteArray(m_arrayId, m_items);
        }
        ...
        public MMapListBase(int arrayId, IArrayAllocator<T> allocator, int maxCapacity, int capacity)
        {
            m_arrayId = arrayId;
        ...
        public MMapListBase(int arrayId, IArrayAllocator<T> allocator, int maxCapacity, T[] items)
        {
            m_maxCapacity = maxCapacity;
        ...
        public void AddItem(T item)
        {
            ...
            else if (m_size == m_items.Length)
            {
                ...
                ArrayAllocator.Return(m_items, clearArray: PoolListBase<T>.s_clearArrayOnReturn);
